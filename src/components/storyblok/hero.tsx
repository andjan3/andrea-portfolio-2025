...
export const Hero = ({ blok }: any) => {
  return (
    ...
    >
      <div className="relative w-[100%] h-[100vh] lg:h-[110vh]">
        <Image
      ...
      <div className="absolute top-0 left-0 w-[100%] h-[100vh] lg:h-[110vh] bg-black opacity-40 z-10"></div>
      <div className="z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] pt-10 lg:pt-0 lg:w-[40%] text-white flex flex-col gap-5">
        <div className="flex justify-start items-center gap-4 ">
          <hr className="w-[10%] border-t-2 border-[#FBD784]" />
          <span className="block text-lg">{blok.hero_subtitle}</span>
        </div>

        <h1 className="text-4xl  text-white lg:w-[60%]">{blok.hero_title}</h1>
